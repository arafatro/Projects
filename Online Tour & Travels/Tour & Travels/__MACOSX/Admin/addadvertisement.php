    ...
    <div class="col-sm-9">
        ...
        <form method="post" enctype="multipart/form-data">
            <table border="0" width="400px" height="300px" align="center" class="tableshadow">
                <tr>
                    <td colspan="2" class="toptd">Add Advertisement</td>
                </tr>
                <tr>
                    <td class="lefttxt">Title</td>
                    <td><input type="text" name="t1" required pattern="[a-zA-z _]{3,50}" title"Please Enter Only
                        Characters between 3 to 50 for Title" />
                    </td>
                </tr>
                <tr>
                    <td class="lefttxt">Company Name</td>
                    <td><input type="text" name="t2" required="required" pattern="[a-zA-z. _]{3,50}" title"Please Enter
                        Only Characters between 3 to 50 for Company name" />
                    </td>
                </tr>
                <tr>
                    <td class="lefttxt">Upload Pic</td>
