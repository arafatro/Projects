...
<div style="width:1000px; margin:auto">
    ...
    <div style="width:200px; float:left">
        ...
        <table cellpadding="0" cellspacing="0" width="1000px">
            <tr>
                <td style="font-size:20px; font-family:Lucida Calligraphy; color:#09F"><b>Category</b></td>
            </tr>
            <?php
    ...
    <div style="width:800px; float:left">
        <table cellpadding="0px" cellspacing="0" width="1000px">
            <tr>
                <td class="headingText">Subcategories</td>
            </tr>
            <tr>
                        ...
                        while ($data = mysqli_fetch_array($result)) {
                            ...
                            <td>
                                <table border="0" width="100px" bordercolor="#FF6666">
                                    ...
                                    <tr>
                                        <td align="center"
                                            style="background-color:#60B0E6; font-family:Lucida Calligraphy; color:#FFF"><?php echo $data[1]; ?> </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center"
                                            style="background-color:#60B0E6; font-family:Lucida Calligraphy"><a
                                                    href="package.php?subcatid=<?php echo $data[0]; ?>"><font
                                                        color="#FFFFFF">View Detail</font></a></td>
                                    </tr>
