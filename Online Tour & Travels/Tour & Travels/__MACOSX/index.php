...
<div class="tour-guides section" id="section-4">
    <div class="tour-guides-head text-center">
        ...
        <div class="container">
            <p>My Tour guides are expensive, so first decide what you want to do, whether it's a general tour of a city,
                a day of hiking, or visiting remote villages in a third-world country. Have a ball-park time allotment
                in mind, whether it's a half-day, a full-day, or a multi-day experience. Once you have chosen a guide,
        ...
        <div class="contact-grids">
            <div class="container">
                <div class="col-md-4 address">
                    <h4 style="color:#09F">My Tour Enterprise</h4>
                    <p style="color:#000">NEED HELP BOOKING PACKAGE For fantastic suggestions you may also call our
                        travel expert.<br/>
                        For fantastic suggestions you may also call our travel expert</p>
                    <h5 style="color:#000"><span class="img1"></span>(+880) 16888 90973&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+880)
                        16888 90975</h5>
                    <h5 style="color:#000"><span class="img2"></span><a href="#">info@mytour.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;support@mytour.com</a>
                    </h5>
                    <h5 style="color:#000"><span class="img3"></span>11 High Street Road, Nikunja, Dhaka.</h5>
                    <br/>
                ...
                <div class="col-md-8 contact">
                    ...
                    <form method="post">
                        <table border="0" width="700px" height="500px">
                            <tr>
                                <td align="left"><input type="text" class="text" value=" Name" name="t1"
                                                        onFocus="this.value = '';"
                                                        onBlur="if (this.value == '') {this.value = 'Your Name';}"
                                                        required pattern="[a-zA-z1 _]{1,50}" title"Please Enter Only
                                    Characters and numbers between 1 to 50 for Name">
                                </td>
                            </tr>
                            <tr>
                                <td align="left"><input type="text" class="text" value=" Contact No" name="t2"
                                                        ...
                                                        required pattern="[0-9]{10,12}" title"Please Enter Only numbers
                                    between 10 to 12 for Contact no">
                                </td>
                            </tr>
                            <tr>
                                <td align="left"><input type="text" class="text" value="Email" name="t3"
                                                        onFocus="this.value = '';"
                                                        onBlur="if (this.value == '') {this.value = 'Your mail';}"
                                                        required></td>
                            </tr>
                            <tr>
                                <td><textarea onFocus="if(this.value == 'Message') this.value='';" name="t4"
                                              onBlur="if(this.value == '') this.value='Enter Message Here';" required/
                                    >Message</textarea></td>
                            </tr>
                            <tr>
            ...
            <div class="map">
				...
				hl=en&amp;coord=23.798715634020667, 90.45239210128786&amp;
				q=united%20international%20university+(Solution%20Finder%20Office)&amp;
				ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed" frameborder="0"
                            scrolling="no" marginheight="0" marginwidth="0"><a
                                href="https://www.maps.ie/create-google-map/">Add map to website</a></iframe>
                </div>
                <br/>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="col-md-4 about-grids">
                    ...
                    <p>Vacation is a time to relax in safe surroundings.For emergency aid of any kind, call 911 from any
                        phone... in your hotel, dial 9-911.</p>
                    <div align="right"><a href="aboutus.php"><input type="button" value="Read More" name="sbmt"/></a>
                    </div>
                </div>
            </div>
        </div>
